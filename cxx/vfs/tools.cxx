...
vfs::split_basename_extension_data
vfs::split_basename_extension(const std::filesystem::path& filename) noexcept
{
...
std::filesystem::path
vfs::unique_path(const std::filesystem::path& path, const std::filesystem::path& filename,
