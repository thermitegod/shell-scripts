...
/**
 * @brief Split a filename into its basename and extension,
...
/**
 * @brief unique_path - Create a unique path given a base path and a filename.
 * If the filename already exists then the filename will be modified with an integer counter.
